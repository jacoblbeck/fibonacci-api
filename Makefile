...
build:
	@echo
	@echo "### Building release/fibonacci-api binary"
	GOOS=linux CGO_ENABLED=0 go build -o release/fibonacci-api github.com/jacoblbeck/fibonacci-api/cmd
...
build-static:
	@echo
	@echo "### Building static release/fibonacci-api  binary"
	CC=x86_64-linux-musl-gcc GOOS=linux CGO_ENABLED=0 go build -a -ldflags '-extldflags "-static"' -o release/fibonacci-api github.com/jacoblbeck/fibonacci-api/cmd
